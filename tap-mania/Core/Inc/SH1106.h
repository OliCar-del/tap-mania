...
#define TEXT_OFFSET_Y 1 // Top padding for first line
#define LINE_TEXT_Y_OFFSET 2 // Inner padding inside the 12px
    ...
    void write_to_oled(char*** song_names, int song_count, int song_selected, int* highlighted_offset);
...
#define SH1106_I2C_TIMEOUT 20000
    ...
    void write_to_oled(char*** songData, int song_count, int song_selected, int* highlighted_offset);
